...
{
	PointXYZCloud cloud(new PointXYZCloud::element_type);
...
{
	PointXYZRGBCloud cloud(new PointXYZRGBCloud::element_type);
...
{
	PointXYZRGBNormalCloud cloud(new PointXYZRGBNormalCloud::element_type);
